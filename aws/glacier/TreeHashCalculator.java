...
/**
 * Computes the SHA-256 Tree Hash of a file to verify that it has correctly been
 * uploaded to AWS Glacier. This is required in the final step of the upload
 * process where the upload is finalized by verifying the file contents on AWS
 * servers is the same as the file locally. The code below has been provided by
 * AWS.
 */
